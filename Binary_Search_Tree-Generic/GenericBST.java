...
// Standard Node class with generic type
class Node<T>
{
	T data;
	Node<T> left, right;
...
public class GenericBST<T extends Comparable<T>>
{
	...
	private Node<T> delete(Node<T> root, T data)
	{
		...
		{
			// Once found, check all children cases
			...
			{
				// If it has two children move largest of left tree up
